...
export const createStudentSchema = z.object({
  body: z.object({
    ...
    Section_ID: z.coerce.number().int().positive('Section_ID must be a positive integer').optional(),
    Profile_Picture: base64ImageValidator,
...
export const updateStudentSchema = z.object({
  ...
  body: z.object({
    ...
    Department: z.string().optional(),
    Section_ID: z.coerce.number().int().positive('Section_ID must be a positive integer').optional(),
    Profile_Picture: z.union([base64ImageValidator, z.null()]).optional(),
